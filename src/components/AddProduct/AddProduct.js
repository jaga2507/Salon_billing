              ...
              <div>
                ...
                <div>
                  <div className='cus_number'>
                    ...
                    <div className='cus_input'>
                      <Input color="warning" placeholder='Enter the Product name' onChange={e=>setName(e.target.value)} />
                ...
                <div>
                  ...
                  Enter the Product Price
                    ...
                    <div className='cus_input' >
                      <Input color="warning" placeholder='Enter the Product Price'  onChange={e=>{setNumber(e.target.value)}} />
