...
function Bill_mode(props) {
  ...
  const [openBoxs, setOpenBoxs] = React.useState(true);
  
  // const [openBoxs, setOpenBoxs] = React.useState(false);
  const [id, setId] = React.useState("");
  const [names, setNames] = React.useState("");
  const [nameprop, setNamesprop] = React.useState([]);
  
  
  const [amount, setAmount] = React.useState("");
  const [amountprop, setAmountprop] = React.useState([]);
  ...
  console.log("setnames", ...nameprop)
  console.log("setopenss", amountprop)
            ...
            <div className='bill_flex' >
              <div>
                ...
                <div className="cus_num" >
                  <LocalPhoneIcon /><span>{props.cusNum}</span>
                </div>
                <div>
